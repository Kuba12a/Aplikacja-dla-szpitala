  ...
  public sealed partial class MainPage : Page
  {
    ...
    public MainPage( )
    {
      ...
      this.DataContext = this.Controller;
        ...
        private void searchTextDate_TextChanged(object sender, TextChangedEventArgs e)
        {

        }

        private void searchTextDate_TextChanged_1(object sender, TextChangedEventArgs e)
        {

        }

        private void searchTextDate_TextChanged_2(object sender, TextChangedEventArgs e)
        {
